...
export default class MultiSelectPickList extends LightningElement {
    ...
    @api elementname; // for testing remove from html and js

    connectedCallback() {
        //debugger;
        console.log("$$$ this.elementname", JSON.stringify(this.elementname));
        ...
        if( this.searchString && this.searchString.length > ZERO ) {
            ...
            if(this.searchString.length >= TWO) {
                ...
                for(let index = ZERO; index < this.optionData.length; index+=ONE) {
                    if(this.optionData[index].label.toLowerCase().trim().includes(this.searchString.toLowerCase().trim())) {
