...
export default class HelpSupportCmp extends LightningElement {
    ...
    componentTitle = "Help and Support";
    subTitleOne = "HELP";
    subTitleTwo = "CONTACT SUPPORT";
    descriptionOne = "Please refer this Document for help regarding any functionality.";
    ...
    handleSubmit(){
        ...
        submitCase({
            ...
            if (result) {
                this.showToast("Case has been submitted","You will hear back from us soon","success","dismissable");
    ...
    saveCurrentSection(){
        this.setupConfig.currentSection = 'helpSupportCmp';
        saveUIToSf({
        ...
        .catch(error => {
            this.error = error;
            this.showLoading = false;
            this.showToast("Something Went Wrong in saveUIToSf",error,"error","dismissable");
        })
    }
